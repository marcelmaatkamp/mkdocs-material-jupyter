...
Builds [ghcr.io/marcelmaatkamp/mkdocs-material-jupyter:${{env.MKDOCS_MATERIAL_VERSION}}](ghcr.io/marcelmaatkamp/mkdocs-material-jupyter:${{env.MKDOCS_MATERIAL_VERSION}})
